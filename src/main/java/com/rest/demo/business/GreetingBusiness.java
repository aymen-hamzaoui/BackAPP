...
public class GreetingBusiness {
    ...
    public Greeting badGreeting() {
        Greeting grt = new Greeting();
        grt.setMessage("Votre nom est ce qui fait de vous une personne si spéciale. N'ayez aucune crainte à le mentionner :). Merci de le renseigner sous la forme gretting/message/nom");
        return grt;
    }
}
